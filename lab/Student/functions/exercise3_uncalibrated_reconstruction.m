...
%------------------------------
% FILL IN THIS PART 
% use the H to rectify all 3d points
for i=1:size(points3d,2)
    points3d(:,i) = H * points3d(:,i);
end
% rectify the camera centers
for i=1:size(camera_centers,2)
    camera_centers(:,i) = H * camera_centers(:,i);
end
